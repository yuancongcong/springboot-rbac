    ...
    <el-row>
        ...
        <el-col :span="24">
            ...
            <el-table :data="tableData" @selection-change="selsChange" v-loading="loading" stripe border ref="table">
                ...
                <el-table-column prop="disabled" label="禁用" width="100">
                ...
                <el-table-column label="操作" width="300">
                    <template slot-scope="scope">
                        <el-button size="small" @click="handleMenus(scope.row)">菜单配置</el-button>
...
<script>
import { getListPage, deleteByIds } from '@/api/system/role.service'
...
export default {
    ...
    methods: {
        ...
        handleMenus(row) {
            this.$router.push(`role/menu-setting/`+row.id)
        },
        async handleDel(ids) {
